    ...
    : pScreen_{nullptr}
{
    ...
    */
    ...
    SMALL_RECT windowRect = {0, 0, static_cast<SHORT>(SCREEN_WIDTH - 1), static_cast<SHORT>(SCREEN_HEIGHT - 1)};
    ...
    */
    ...
    hConsole_ = CreateConsoleScreenBuffer(GENERIC_READ | GENERIC_WRITE, 0, NULL, CONSOLE_TEXTMODE_BUFFER, NULL);
    if (!hConsole_)
