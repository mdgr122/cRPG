...
Actor::Actor(const std::wstring &name, const std::wstring &id, int level, int max_hp, int max_mp, ActorType type)
    ...
    , m_eActorType{type}
    , m_mapEquipmentSlots{
        // Initializing the unordered_map of EquipmentSlots so we don't get mem errors if nothing is equipped
        {Stats::EquipSlots::WEAPON, nullptr}, {Stats::EquipSlots::HEADGEAR, nullptr}, {Stats::EquipSlots::CHEST_BODY, nullptr}, {Stats::EquipSlots::FOOTWEAR, nullptr},
