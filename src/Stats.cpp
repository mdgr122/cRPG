...
Stats::Stats(int strength, int intelligence, int speed, int dexterity, int stamina)
    : m_StatList{{L"Attack", 0}, {L"Defense", 0}, {L"Magic", 0}, {L"Strength", strength}, {L"Intelligence", intelligence}, {L"Speed", speed}, {L"Dexterity", dexterity},
                 {L"Stamina", stamina}}
    , m_StatModifierList{{L"Strength", 0}, {L"Intelligence", 0}, {L"Speed", 0}, {L"Dexterity", 0}, {L"Stamina", 0}}
    , m_EquipSlotList{{EquipSlots::WEAPON, 0}, {EquipSlots::HEADGEAR, 0}, {EquipSlots::CHEST_BODY, 0}, {EquipSlots::FOOTWEAR, 0}, {EquipSlots::ACCESSORY, 0},}
{
...
void Stats::UpdateStats()
{
    ...
    m_StatList[L"Attack"] = m_EquipSlotList[EquipSlots::WEAPON] + baseStrength + (baseIntelligence / 5) + (baseDexterity / 5);

    // Update defense power stat
    int totalArmourDefense = (m_EquipSlotList[EquipSlots::HEADGEAR] + m_EquipSlotList[EquipSlots::CHEST_BODY] + m_EquipSlotList[EquipSlots::FOOTWEAR]);

    m_StatList[L"Defense"] = totalArmourDefense + (baseStrength / 5) + (baseIntelligence / 5) + (baseSpeed / 5) + (baseDexterity / 5);
}
