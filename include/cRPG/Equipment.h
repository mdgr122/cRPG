...
public:
    ...
    inline const ArmourProperties &GetArmourProperties() const
    {
        return m_ArmourProperties;
    }
...
public:
    ...
    {
        return m_WeaponProperties.attackPower;
    }
...
public:
    ...
    inline const int GetValue() const override
    {
        return m_ArmourProperties.defensePower;
    }
